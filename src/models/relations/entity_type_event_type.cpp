...
et_et::Entity_type_event_type(const std::string& entity_type,
  ...
  m_entity_type(his_gen::String_to_enum(entity_type, entity_type_lookup)),
...
et_et::Entity_type_event_type(const his_gen::EEntity_type& entity_type,
  ...
  m_entity_type_string(his_gen::Enum_to_string(entity_type, entity_type_lookup)),
                        ...
                        his_gen::Entity_type_event_type& entity_type_event_type)
{
  ...
  entity_type_event_type.Set_entity_type(his_gen::String_to_enum(entity_type_event_type.Get_entity_type_string(),
                                                                 entity_type_lookup));
