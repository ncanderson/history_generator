...
#ifndef ELOPEMENT_EVENT_H
#define ELOPEMENT_EVENT_H
...
{
/**
 * @brief Represents the 'elopement' event
 */
class Elopement_event : public Event_base
{
public:
  // Attributes
   ...
   */
  Elopement_event(std::shared_ptr<his_gen::Entity_base>& triggering_entity,
