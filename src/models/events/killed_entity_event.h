...
#ifndef KILLED_ENTITY_EVENT_H
#define KILLED_ENTITY_EVENT_H
...
{
/**
 * @class Killed_Entity_event
 * @brief Represents the killed_entity event
 */
class Killed_entity_event : public Event_base
{
public:
  /**
