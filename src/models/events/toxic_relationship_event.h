...
#ifndef TOXIC_RELATIONSHIP_EVENT_H
#define TOXIC_RELATIONSHIP_EVENT_H
...
{
/**
 * @brief Represents the 'toxic relationship' event
 */
class Toxic_relationship_event : public Event_base
{
public:
  // Attributes
