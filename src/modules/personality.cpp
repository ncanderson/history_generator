...
void his_gen::Personality::construct_personality_attributes()
{
  ...
  int8_t ambitious_content = his_gen::Make_a_roll(100);
  ...
  int8_t avoidant_sociable = his_gen::Make_a_roll(100);
  ...
  int8_t jealous_compassionate = his_gen::Make_a_roll(100);
  ...
  int8_t placid_excitable = his_gen::Make_a_roll(100);
  ...
  int8_t argumentative_amiable = his_gen::Make_a_roll(100);
  ...
  int8_t witty_humorless = his_gen::Make_a_roll(100);
