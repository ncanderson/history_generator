...
his_gen::Myth_era_narrator::Myth_era_narrator(const his_gen::Data_access_manager& data_access_manager,
...
void his_gen::Myth_era_narrator::Create_progenitor_deity(std::vector<std::shared_ptr<his_gen::Entity_base>>& entities)
{
...
void his_gen::Myth_era_narrator::Create_entities(std::vector<std::shared_ptr<his_gen::Entity_base>>& entities,
...
std::shared_ptr<his_gen::Entity_base> his_gen::Myth_era_narrator::create_entity()
{
